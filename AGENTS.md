...
- Do not duplicate code across crates or modules; keep things DRY. Reuse existing abstractions and shared helpers rather than creating redundant implementations.
